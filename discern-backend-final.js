// Discern AI Backend - Original Moments with AI Questions
...
const MOMENTS = {
  1: {
    ...
    prompt_context: `The person is facing a difficult conversation they need to have. Generate questions that help them think clearly about what needs to be said, separate facts from interpretation, consider the other person's perspective, clarify what really matters, and surface emotional risks that might throw them off.`,
  ...
  2: {
    ...
    prompt_context: `The person is feeling overwhelmed with everything feeling urgent. Generate questions that help them distinguish real urgency from perceived urgency, identify what's driving the pressure, clarify actual consequences, and decide what deserves attention right now versus what can wait.`,
  ...
  3: {
    ...
    prompt_context: `The person needs to say no to someone but is finding it difficult. Generate questions that help them clarify the real reason for saying no, understand their concerns about the impact, assess what's fair to both parties, and prepare to communicate the boundary clearly while maintaining connection.`,
  ...
  4: {
    ...
    prompt_context: `Someone is upset with the person and they need to respond. Generate questions that help them see the situation from the other person's perspective, understand what they might have missed, recognize their own emotional reaction, and prepare to respond well without being defensive or over-apologetic.`,
  ...
  5: {
    ...
    prompt_context: `The person has made a mistake and needs to address it. Generate questions that help them describe what actually happened objectively, assess the real impact versus their fears, identify who needs to know and what they need, understand what owning it well looks like, and recognize emotional risks that might make them hide or over-apologize.`,
...
5. **Focus on clarity, not therapy**
   ...
   - Questions should surface what matters most
   - Questions should help them see what they might be missing
